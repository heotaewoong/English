...
const CLIPS: Clip[] = [
  { id: 'c1', title: 'Sleep is Your Superpower', channel: 'TED', channelColor: '#ef4444', duration: '19:18', level: 3, category: 'Science', expressions: ['"be attuned to"', '"settle in"', '"vigilant"', '"novel environment"'], thumbnail: '#6366f1', stepsCompleted: ['watch', 'listen', 'speak'], views: '1.4M', rating: 4.7, youtubeUrl: ytSearch('Sleep is Your Superpower Matt Walker TED', 'TED'), youtubeId: '5MuIMqhT8DM', sentences: ["When you sleep somewhere unfamiliar, your brain stays alert.", "Half of your brain remains awake to monitor for danger.", "This is known as the first-night effect.", "Your sleep quality is significantly reduced on the first night.", "The brain gradually adapts over the following nights."] },
  { id: 'c2', title: 'The Paradox of Choice', channel: 'Kurzgesagt', channelColor: '#06b6d4', duration: '5:12', level: 3, category: 'Science', expressions: ['"cognitive load"', '"overwhelmed by options"', '"decision fatigue"'], thumbnail: '#0ea5e9', stepsCompleted: ['watch', 'listen'], views: '3.2M', rating: 4.9, youtubeUrl: ytSearch('The Paradox of Choice Kurzgesagt', 'Kurzgesagt'), youtubeId: '5kF2XGFX0dc', sentences: ["We make thousands of decisions every single day.", "Having too many options can actually make us less happy.", "This is called decision fatigue.", "Our willpower decreases throughout the day.", "Limiting your choices can lead to better decisions."] },
  { id: 'c3', title: 'How to Introduce Yourself Confidently', channel: 'BBC Learning English', channelColor: '#3b82f6', duration: '2:58', level: 1, category: 'Daily Life', expressions: ['"Nice to meet you"', '"I\'ve heard a lot about you"', '"Pleasure to be here"'], thumbnail: '#3b82f6', stepsCompleted: ['watch'], views: '890K', rating: 4.6, youtubeUrl: ytSearch('How to Introduce Yourself Confidently', 'BBC Learning English'), youtubeId: 'WDJlTaihMsY', sentences: ["Nice to meet you, I've heard a lot about you.", "It's a pleasure to be here today, thank you for having me.", "I'm really looking forward to working with you.", "Let me tell you a little bit about myself.", "I've been working in this field for about five years."] },
  { id: 'c4', title: 'iPhone 16 Pro: The Biggest Upgrade Yet', channel: 'Marques Brownlee', channelColor: '#ef4444', duration: '6:20', level: 2, category: 'Tech & AI', expressions: ['"game changer"', '"in terms of"', '"under the hood"'], thumbnail: '#ef4444', stepsCompleted: [], views: '5.6M', rating: 4.8, youtubeUrl: ytSearch('iPhone 16 Pro review', 'Marques Brownlee MKBHD'), youtubeId: 'MRtg6A1f2Ko', sentences: ["This is definitely a game changer for the smartphone industry.", "Under the hood, there are some really major improvements.", "In terms of camera quality, this is the best we've seen yet.", "The battery life has improved significantly this year.", "Overall, I think this is absolutely worth the upgrade."] },
  { id: 'c5', title: 'How Great Leaders Inspire Action', channel: 'TED', channelColor: '#ef4444', duration: '18:04', level: 4, category: 'Business', expressions: ['"lead by example"', '"foster trust"', '"empower your team"'], thumbnail: '#8b5cf6', stepsCompleted: [], views: '2.3M', rating: 4.9, youtubeUrl: ytSearch('How Great Leaders Inspire Action Simon Sinek TED', 'TED'), youtubeId: 'qp0HIF3SfI4', sentences: ["Great leaders always lead by example.", "They foster trust within their teams.", "A good leader knows how to empower others.", "Setting the right tone is essential from the very start.", "Leadership is about inspiring people, not just managing them."] },
  { id: 'c6', title: 'My Morning Routine', channel: "Matt D'Avella", channelColor: '#8b5cf6', duration: '7:13', level: 2, category: 'Daily Life', expressions: ['"get into the zone"', '"kick-start my day"', '"non-negotiable"'], thumbnail: '#a855f7', stepsCompleted: ['watch', 'listen', 'speak'], views: '1.8M', rating: 4.7, youtubeUrl: ytSearch('My Morning Routine Matt D Avella', "Matt D'Avella"), youtubeId: '5-IggORYVT0', sentences: ["My morning routine is completely non-negotiable.", "I wake up at six and immediately get into the zone.", "Exercise is the first thing I do to kick-start my day.", "A productive morning sets the tone for everything else.", "Consistency is the key to building any good habit."] },
  { id: 'c7', title: 'How the Stock Market Actually Works', channel: 'Graham Stephan', channelColor: '#22c55e', duration: '5:45', level: 3, category: 'Finance', expressions: ['"bear market"', '"diversify your portfolio"', '"compound interest"'], thumbnail: '#10b981', stepsCompleted: [], views: '4.1M', rating: 4.6, youtubeUrl: ytSearch('How the Stock Market Works', 'Graham Stephan'), youtubeId: 'dMOcrLMfDFM', sentences: ["Diversifying your portfolio reduces your overall risk.", "Compound interest is the most powerful force in investing.", "Don't try to time the market, just play the long game.", "During a bear market, opportunities are actually everywhere.", "Always invest in what you truly understand."] },
  { id: 'c8', title: 'Pronunciation Mistakes Korean Speakers Make', channel: "Rachel's English", channelColor: '#ec4899', duration: '4:00', level: 2, category: 'Daily Life', expressions: ['"How about you?" vs "What about you?"', '"I\'m home" vs "I\'m at home"'], thumbnail: '#ec4899', stepsCompleted: [], views: '760K', rating: 4.8, youtubeUrl: ytSearch('Pronunciation Mistakes Korean Speakers Make', "Rachel's English"), youtubeId: 'swKZ8qZ9j4E', sentences: ["How about you? What do you think about this?", "I'm home! I just got back from work.", "Do you mind if I open the window?", "Could you do me a favor?", "I was wondering if you could help me out."] },
  { id: 'c9', title: 'Exploring Tokyo Street Food', channel: 'Yes Theory', channelColor: '#0ea5e9', duration: '7:10', level: 2, category: 'Travel', expressions: ['"I cannot recommend this enough"', '"blown away"', '"you gotta try this"'], thumbnail: '#0ea5e9', stepsCompleted: ['watch', 'listen', 'speak'], views: '2.7M', rating: 4.9, youtubeUrl: ytSearch('Tokyo Street Food Travel Vlog', 'Yes Theory'), youtubeId: '-E8ZiR-6oB4', sentences: ["I cannot recommend this place enough.", "I was completely blown away by the food here.", "You've absolutely gotta try this ramen.", "This has been one of the best experiences of my life.", "Tokyo is unlike any city I've ever been to."] },
  { id: 'c10', title: 'The Future of AI Explained Simply', channel: 'Vox', channelColor: '#eab308', duration: '5:55', level: 3, category: 'Tech & AI', expressions: ['"paradigm shift"', '"disrupting the status quo"', '"at the forefront of"'], thumbnail: '#f59e0b', stepsCompleted: [], views: '6.2M', rating: 4.7, youtubeUrl: ytSearch('The Future of Artificial Intelligence Explained', 'Vox'), youtubeId: '0KMeeeZOszA', sentences: ["Artificial intelligence represents a true paradigm shift.", "AI is disrupting the status quo across every single industry.", "We are at the forefront of an unprecedented technological change.", "The implications of this technology are truly far-reaching.", "How we adapt to AI will define the next decade."] },
  { id: 'c11', title: 'How to Stop Procrastinating', channel: 'Ali Abdaal', channelColor: '#6366f1', duration: '6:45', level: 3, category: 'Daily Life', expressions: ['"bite the bullet"', '"just start"', '"immediate short-term reward"'], thumbnail: '#6366f1', stepsCompleted: ['watch'], views: '3.4M', rating: 4.8, youtubeUrl: ytSearch('How to Stop Procrastinating', 'Ali Abdaal'), youtubeId: 'hJZ5v7dpKKM', sentences: ["The key to beating procrastination is to just start.", "Bite the bullet and begin, no matter how small the step.", "Our brains are wired to seek immediate short-term rewards.", "Breaking tasks into smaller pieces makes them far more manageable.", "Done is always better than perfect."] },
  { id: 'c12', title: 'How to Negotiate Your Salary', channel: 'CNBC', channelColor: '#0891b2', duration: '4:30', level: 4, category: 'Business', expressions: ['"come to the table with"', '"counter-offer"', '"market rate"'], thumbnail: '#0891b2', stepsCompleted: [], views: '1.1M', rating: 4.6, youtubeUrl: ytSearch('How to Negotiate Your Salary', 'CNBC'), youtubeId: 'A8h955_vvh8', sentences: ["Always come to the table with a clear sense of your own value.", "Research the market rate before any salary negotiation.", "Know your walk-away point before the conversation starts.", "A counter-offer is a completely normal part of the process.", "Negotiating your salary is one of the most important life skills."] },
  { id: 'c13', title: 'Simple Habits for Better Mental Health', channel: 'Psych2Go', channelColor: '#10b981', duration: '3:20', level: 2, category: 'Health', expressions: ['"take a toll on"', '"be gentle with yourself"', '"check in with yourself"'], thumbnail: '#10b981', stepsCompleted: [], views: '2.0M', rating: 4.7, youtubeUrl: ytSearch('Simple Habits for Better Mental Health', 'Psych2Go'), youtubeId: '8hURsYi9ZeA', sentences: ["Stress and anxiety can really take a toll on your health.", "It's so important to be gentle with yourself.", "Check in with yourself regularly throughout the day.", "Small habits can make a huge difference over time.", "Your mental health is just as important as your physical health."] },
  { id: 'c14', title: "A Beginner's Guide to Investing", channel: 'Andrei Jikh', channelColor: '#f59e0b', duration: '8:15', level: 3, category: 'Finance', expressions: ['"index fund"', '"time in the market"', '"dollar-cost averaging"'], thumbnail: '#f59e0b', stepsCompleted: [], views: '4.8M', rating: 4.9, youtubeUrl: ytSearch("Beginner's Guide to Investing 2025", 'Andrei Jikh'), youtubeId: 'XlibDPyMnak', sentences: ["Index funds are one of the best ways to start investing.", "Time in the market beats timing the market every time.", "Dollar-cost averaging significantly reduces your risk over time.", "Start investing early to fully benefit from compound interest.", "Even small amounts invested consistently can grow dramatically."] },
];
